...
/// Create an ONNX session using only the CPU execution provider.
///
/// Use this for models that are incompatible with GPU EPs (e.g. DirectML
/// crashing on certain int8 quantized models like Paraformer).
