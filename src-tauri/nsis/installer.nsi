; Custom NSIS template for Yukey with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Yukey for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older Yukey releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Yukey Portable Mode"
    FileClose $0
